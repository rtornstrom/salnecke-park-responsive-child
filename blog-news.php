 ...
 * @filesource     wp-content/themes/salnecke-park-responsive-child/blog-news.php
...
<div id="content-blog" class="<?php echo implode( ' ', responsive_get_content_classes() ); ?>">
	...
	$blog_query = new WP_Query( array( 'category__not_in' => array( 6 ), 'post_type' => 'post', 'paged' => $paged ) );
	$temp_query = $wp_query;
	$wp_query = null;
	$wp_query = $blog_query;
